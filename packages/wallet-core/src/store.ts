...
export function walletObjectsFromCards(
  cards: WalletCard[],
): WalletStoredObject[] {
...
export function walletObjectsFromHistory(
...
export function walletObjectsFromShl(
...
export function walletObjectFromCredentialOffer(
  parsed: ParsedCredentialOffer,
): WalletStoredObject {
  return {
...
export function walletObjectFromPresentationRequest(
...
export function walletObjectFromServicePacket(
  packet: ServicePacketResponse | CheckinQrResponse,
): WalletStoredObject {
...
export function mergeWalletObjects(
  ...groups: WalletStoredObject[][]
): WalletStoredObject[] {
