...
const aliases: Record<string, CanonicalDocumentType> = {
  ...
  eligibility_result: "insurance_eligibility",
  coverage_eligibility: "insurance_eligibility",
  coverage_eligibility_response: "insurance_eligibility",
  claim: "claim_package",
  claim_submission: "claim_package",
  claim_submission_package: "claim_package",
  receipt: "claim_receipt",
  claim_submission_receipt: "claim_receipt",
  claim_status: "claim_receipt",
  travel_document: "travel_document_verification",
  passport: "travel_document_verification",
  visa: "visa_support_letter",
  medical_visa: "visa_support_letter",
  visa_support: "visa_support_letter",
  guarantee: "guarantee_letter",
  guarantee_letter: "guarantee_letter",
  letter_of_guarantee: "guarantee_letter",
  quote: "quotation",
  shl: "shl_manifest",
