...
export function PrepareScreen() {
  ...
  const apiOptions = useMemo(() => ({ url: env.apiUrl, demoMode: env.demoMode, demoOrigin: "https://trustcare-wallet.local", userId: user.id }), [user.id]);
  ...
  useEffect(() => {
    void walletApi.readiness(apiOptions, { context, patientId: user.patientId }).then(setReadiness);
